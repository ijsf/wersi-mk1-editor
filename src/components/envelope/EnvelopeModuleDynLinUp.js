...
export default class EnvelopeModuleDynLinUp extends EnvelopeModule {
  static defaultProps = {
    ...EnvelopeModule.defaultProps,
    title: 'Dyn. linear up',
    description: 'Linearly increases the envelope with dynamic volume',
		aTitle: 'Duration',
    ...
    const { TIMESTEP, TIMESTEP7, TIMESTEP12 } = WersiClient.ENVELOPE;
		...
		*/
		return {
			...
			data: [
				{ x: 0, y: amplBefore },
				{ x: EnvelopeModuleDynLinUp.timeLUT[a]/1000, y: (amplBefore > b) ? amplBefore : b }
			]
		};
  }
}
